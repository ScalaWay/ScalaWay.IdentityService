    ...
    public partial class Identity : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TeamMembers", x => new { x.TeamId, x.AccountId });
                    table.ForeignKey(
            ...
            migrationBuilder.InsertData(
                table: "Roles",
                columns: new[] { "Id", "ConcurrencyStamp", "Description", "IsDefault", "IsStatic", "Name", "NormalizedName", "RoleType" },
                values: new object[] { new Guid("be3ea476-dcc1-48de-a081-b0349a107ca4"), "e3df5a38-8ef1-4914-b74e-4d89f61a4ec9", null, false, false, "Team Owner", null, "Team" });
